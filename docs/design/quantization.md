...
handle mixed SWA/global layer widths and final logit softcap for that subset.
Real Gemma4 Q4_K_M execution remains blocked until sliding-window/shared-KV,
