...
- [x] M7.1 Build a scheduler test harness with a mock model.
...
- [x] M7.2 Define scheduler work item types.
...
- [x] M7.3 Preserve batched/unbatched greedy parity.
...
- [x] M7.4 Add cancellation behavior.
  - Crates: `ocelotl-runtime`
...
- [x] M7.5 Add bounded queue and backpressure behavior.
  - Crates: `ocelotl-runtime`
...
- [x] M7.6 Add fairness and starvation tests.
  - Crates: `ocelotl-runtime`
...
- [x] M7.7 Integrate scheduler with runtime generation APIs.
  - Crates: `ocelotl-runtime`
...
- [x] M7.8 Document scheduler invariants.
  - Crates: docs only
...
M7 is closed as a deterministic single-process scheduler surface. The runtime
now exposes `ContinuousBatchScheduler`, explicit request state transitions,
bounded admission, cancellation cleanup, fairness tests, and
`generate_qwen_batch` as the public Qwen2.5 batch-generation helper. This is
continuous batching correctness plumbing, not a throughput-optimized GPU or
