...
- [ ] M1.1 Define the shared error taxonomy.
  - Crates: `ocelotl-core`
...
- [ ] M1.2 Define typed scalar and ID newtypes.
  - Crates: `ocelotl-core`
...
- [ ] M1.3 Define typed model metadata structs.
  - Crates: `ocelotl-core`
...
- [ ] M1.4 Reject unsupported metadata explicitly.
...
- [ ] M1.5 Add metadata fixture loading for tests.
...
- [ ] M1.6 Sketch the minimal generation request contract.
...
- [ ] M1.7 Add CPU reference tensor primitives for tiny fixtures.
...
- [ ] M1.8 Add deterministic sampling for greedy output.
...
- [ ] M1.9 Wire a tiny CPU reference generation path.
...
- [ ] M1.10 Document and enforce M1 validation.
